<%@ Page Language="C#" Title="人員權限編輯" AutoEventWireup="true" CodeFile="access.aspx.cs" Inherits="Control_PeoEdit"
    ...
    <body style="background-color: #DFEFFF;color:#0000FF;">
        ...
        <form id="form1" runat="server">
            <asp:TextBox ID="ID" visible="False" runat="server" BackColor="Silver" ReadOnly="True" />
            ...
            <asp:Table class="tbl ms-3" ID="Table1" runat="server" GridLines="Both">
                ...
                <asp:TableRow ID="rowTitle0" runat="server">
                    ...
                    <asp:TableCell runat="server" Width="383px">
                        <div class="d-flex form-group mx-2 my-2 align-content-center">
                            <asp:TextBox class=" form-control " ID="Name" size=15 runat="server" ForeColor="black" placeholder="人員名稱"></asp:TextBox>
                            <asp:TextBox class=" form-control  mx-2" ID="NameID" size=15 runat="server" ForeColor="black" placeholder="人員編號 (可空白)"></asp:TextBox>
                            <a class="btn btn-sm btn-secondary " data-bs-toggle="offcanvas" href="#offcanvasExample1" role="button" aria-controls="offcanvasExample">
                                參考選單
                            </a>
                            <div class="offcanvas offcanvas-end off4width" tabindex="-1" id="offcanvasExample1" aria-labelledby="offcanvasExampleLabel">
                                <div class="offcanvas-header">
                                    <h5 class="offcanvas-title" id="offcanvasExampleLabel">代入人員</h5>
                                </div>
                                <div class="offcanvas-body">
                                    <div class="div-mod mt-2">
                                        <asp:DropDownList id="MenuName" runat="server" AutoPostBack="True" class="h-100 form-select" multiple aria-label="multiple select example" OnSelectedIndexChanged="MenuName_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                    ...
                    <asp:TableCell runat="server" Width="383px">
                        <div class="d-flex form-group mx-2 my-2 ">
                            <asp:TextBox class=" form-control w-50" ID="Telephone" size=40 runat="server" ForeColor="black"></asp:TextBox>
                        </div>
                    </asp:TableCell>
                ...
                <asp:TableRow ID="rowTitle1" runat="server">
                    <asp:TableCell runat="server" Width="105px">
                        單位課別
                    </asp:TableCell>
                    <asp:TableCell runat="server" Width="372px">
                        <div class="d-flex form-group my-2 w-30 align-items-center">
                            <asp:TextBox class="mx-2 form-control form-control-sm" ID="Dept" size=20 runat="server" ForeColor="black"></asp:TextBox>
                            ...
                            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample5" aria-labelledby="offcanvasExampleLabel">
                                <div class="offcanvas-header">
                                    <h5 class="offcanvas-title" id="offcanvasExampleLabel">單位課別</h5>
                                </div>
                                <div class="offcanvas-body">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" onclick="staffok('#Dept', '#staffchos5' , '#offcanvasExample5')">確認</button>
                                </div>
                            </div>
                    ...
                    <asp:TableCell runat="server" Width="372">
                        <div class="d-flex form-group my-2 w-30 align-items-center">
                            <asp:TextBox class="mx-2 form-control form-control-sm" ID="Company" size=20 runat="server" ForeColor="black" placeholder="EX：富士通 (可空白)" />
                            ...
                            <div class="offcanvas offcanvas-end off4width" tabindex="-1" id="offcanvasExample4" aria-labelledby="offcanvasExampleLabel">
                                <div class="offcanvas-header">
                                    <h5 class="offcanvas-title" id="offcanvasExampleLabel">設備廠商</h5>
                                </div>
                                <div class="offcanvas-body">
                                    <div class="dropdown mt-3">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" onclick="staffok('#Company', '#staffchos4' , '#offcanvasExample4')">確認</button>
                                </div>
                            </div>
                            <span class="psword psoan mx-2"> (亦可自行填入)</span>
                        </div>
                ...
                <asp:TableRow ID="rowTitle2" runat="server">
                    ...
                    <asp:TableCell runat="server" Width="372">
                        <div class="mx-2 my-2">
                            <asp:RadioButton id="Radio1" GroupName="RadioGroup1" runat="server" /><span style="color:red">●</span>&nbsp;
                            <asp:RadioButton id="Radio2" GroupName="RadioGroup1" runat="server" /><span style="color:red">Ｘ</span>&nbsp;
                        </div>
                    </asp:TableCell>
                    <asp:TableCell runat="server" Width="113">
                        2F權限
                    ...
                    <asp:TableCell runat="server" Width="372">
                        <div class="mx-2 my-2">
                            <asp:RadioButton id="Radio3" GroupName="RadioGroup2" runat="server" /><span style="color:red">●</span>&nbsp;
                            <asp:RadioButton id="Radio4" GroupName="RadioGroup2" runat="server" /><span style="color:red">Ｘ</span>&nbsp;
                        </div>
                    </asp:TableCell>
                </asp:TableRow>
                ...
                <asp:TableRow ID="rowTitle3" runat="server">
                    ...
                    <asp:TableCell runat="server" Width="383px" colspan="4">
                        <div class="d-flex form-group mx-2 my-2 ">
                            <asp:TextBox class=" form-control w-50" ID="Job" size=80 runat="server" ForeColor="black"></asp:TextBox>
                ...
                <asp:TableRow ID="rowTitle4" runat="server">
                    ...
                    <asp:TableCell runat="server" Width="383px" colspan="4">
                        <div class="d-flex form-group mx-2 my-2 flex-column">
                            <div>
                                <asp:RadioButton id="Radio5" GroupName="RadioGroup3" runat="server" />
                                <span style="color:rgb(132, 2, 2)">A類</span>
                                <span class="psword psoan mx-2">不必通知、不需陪同</span>
                            </div>
                            <div>
                                <asp:RadioButton id="Radio6" GroupName="RadioGroup3" runat="server" />
                                <span style="color:rgb(132, 2, 2)">B類</span>
                                <span class="psword psoan mx-2">需要通知、不需陪同</span>
                            </div>
                            <div>
                                <asp:RadioButton id="Radio7" GroupName="RadioGroup3" runat="server" />
                ...
                <asp:TableRow ID="rowTitle6" runat="server">
                    ...
                    <asp:TableCell runat="server" Width="372px">
                        <div class="d-flex form-group my-2 w-30 align-items-center">
                            <asp:TextBox class="mx-2 form-control form-control-sm w-50" ID="Apdate" size=40 runat="server" ForeColor="black" placeholder="EX：112/2/20 (可空白)" />
                    ...
                    <asp:TableCell runat="server" Width="383px">
                        <asp:TextBox class="mx-2 form-control form-control-sm w-50" ID="Apnumber" size=40 runat="server" ForeColor="black" placeholder="EX：SOS05-2023-0007 (可空白)" />
                    </asp:TableCell>
                </asp:TableRow>
            ...
            <div class="d-flex justify-content-between w-100">
                <div class="psdiv mx-5">
                    
                </div>
                <div class="d-flex">
                    <asp:Button ID="BtnAdd" runat="server" Text="　新　增　" onclick="BtnAdd_Click" class="btn btn-primary mx-2" OnClientClick="return confirm('您確定要新增這筆資料嗎？')" /><br>
                    <asp:Button ID="BtnEdit" runat="server" Text="　修　改　" onclick="BtnEdit_Click" class="btn btn-warning mx-2" OnClientClick="return confirm('您確定要修改這筆資料嗎？')" /><br>
                    <asp:Button ID="BtnDel" runat="server" Text="　刪　除　" onclick="BtnDel_Click" CausesValidation="False" class="btn btn-danger mx-2" OnClientClick="return confirm('您確定要刪除這筆資料嗎？')" />
                </div>
            </div>
